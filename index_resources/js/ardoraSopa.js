...
paintImaDivs($(this).position().left+sizeCell,$(this).position().top,"index_resources/media/i1_Robot.jpg","");
}, function() {$(this).css("cursor","auto");var canvas = document.getElementById("ardoraActSel");var context = canvas.getContext("2d");canvas.width=canvas.width;$("#ardoraActSel").attr("aria-label","");});
}
function defAudioDivs(){
$("#idDiv0").click(function() {$("#audio1").get(0).play();});
}
function paintImaDivs(x,y,imageSrc,nalt){
while(y+150>$("#ardoraActSel").height()){y=y-1};while(x+200>$("#ardoraActSel").width()){x=x-1};
